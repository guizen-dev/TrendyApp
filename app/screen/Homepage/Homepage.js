    ...
    return (
        ...
        <Container style={{flex:1,backgroundColor:'#18171F'}}>
            <ScrollView>
                ...
                >
                    <Text style={{color:'white', fontFamily: 'Montserrat_500Medium', fontSize:20}}>Trends</Text>
                    <SeeAll>
                ...
                >
                    <Text style={{color:'white', fontFamily: 'Montserrat_500Medium', fontSize:20}}>Musics</Text>
                    <SeeAll>
                    <Text style={{color:'purple', fontFamily: 'Montserrat_500Medium', fontSize:16, textDecorationLine: 'underline'}}>See All</Text>
                    </SeeAll>
                </View>
                ...
                >
                    <Text style={{color:'white', fontFamily: 'Montserrat_500Medium', fontSize:20}}>Movies</Text>
                    <SeeAll>
                    <Text style={{color:'purple', fontFamily: 'Montserrat_500Medium', fontSize:16, textDecorationLine: 'underline'}}>See All</Text>
                    </SeeAll>
                </View>
